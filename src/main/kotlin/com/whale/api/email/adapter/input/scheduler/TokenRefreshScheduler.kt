...
class TokenRefreshScheduler(
    ...
    fun refreshExpiredTokens() {
        ...
        try {
            ...
            val expiringAccounts =
                findEmailAccountOutput.findAccountsWithExpiringTokens(
    ...
    fun weeklyTokenCleanup() {
        ...
        try {
            // 30일 이상 만료된 계정들 조회
            val longExpiredAccounts =
                findEmailAccountOutput.findAccountsWithLongExpiredTokens(
                    provider = EmailProvider.GMAIL,
                    expiredDays = 30,
                )
